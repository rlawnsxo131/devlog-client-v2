export default function replaceAssets() {
  const assetsString = `<link rel="shortcut icon" href="/assets/favicon.ico" />
    <link
      rel="icon"
      type="image/png"
      sizes="16x16"
    ...
    <meta name="application-name" content="devlog-client-v2" />
    <link
    ...
    />
    <meta name="apple-mobile-web-app-title" content="devlog-client-v2" />
    <link
  ...
  const prefix =
    process.env.REACT_APP_IMAGE_URL !== '/'
      ...
      : '';
  return assetsString.replace(/\/assets/g, `${prefix}/assets`);
}
